...
Download and extract `ScottBook-v0.27.0-android-debug.apk`, open PowerShell in
...
```powershell
npm run android:device:smoke -- "C:\Users\vligh\Downloads\ScottBook-v0.27.0-android-debug.apk" --serial "DEVICE_SERIAL"
```
