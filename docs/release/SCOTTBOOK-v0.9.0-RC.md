...
| M-07 | Android APK | Fresh install, offline use, Back, upgrade retaining data | Signing and safe-upgrade tooling ready through version code 30; key setup and two-version real-device evidence deferred |
