...
- The offline library contains 45 standards-informed readings, balanced at nine
  each for HSK 1–5. It does not yet cover HSK 6. The texts are original
...
- Character, word/phrase, and sentence assistance is available for all 45
...
- Reader now derives a searchable **Từ trong bài** index from each authored
  ...
  occurrence in the current article or across all 45 offline articles. There
...
- The learning overview derives lifetime progress from the current 45-article
