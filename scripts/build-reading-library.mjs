...
const compressedLibrary = gzipSync(Buffer.from(serializedLibrary), {
  level: 9,
  mtime: 0
}).toString("base64");
const output = `/* This file is generated by scripts/build-reading-library.mjs. */\n` +
  ...
  `export const builtInLibrary = JSON.parse(strFromU8(gunzipSync(compressedBytes))) as readonly BuiltInArticle[];\n`;
