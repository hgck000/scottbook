    ...
    for (const paragraph of article.paragraphs) {
      ...
      for (const sentence of paragraph.sentences) {
        ...
        for (const token of sentence.tokens) {
          const tokenPath = `${sentencePath}/token:${token.id}`;
